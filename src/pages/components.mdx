...
## MDX
>  "MDX is markdown for the component era. It enables seamlessly writing JSX in Markdown documents. That’s a great combination because it allows you to use markdown’s terse syntax (such as # heading) and JSX for more advanced components.

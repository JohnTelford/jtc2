...
> [Gatsby](https://www.gatsbyjs.com/) is the best way to create static websites with React. It lets you use React components, but outputs pre-rendered HTML and CSS to guarantee the fastest load time.  ...React
...
The Gatsby ``build`` command produces a directory of static web standard HTML, CSS, and JavaScript files that is deployed to a vendor cloud-based  web services. 

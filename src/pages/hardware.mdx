...
[Apple](https://www.apple.com) recently released the first Mac products built with the ARM-based, Apple silicon designed, processors, and the macOS Big Sur operating system engineered to use [M1](https://en.wikipedia.org/wiki/Apple_M1) chip capabilities.
...
<img height={100} src={microsoftlogo} />
